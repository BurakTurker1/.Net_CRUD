<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="güncelle.aspx.cs" Inherits="websiteLogin.güncelle" %>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label8" runat="server" Text="Güncellenecek kişi ID"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:Button ID="BtnGüncelle" runat="server" OnClick="BtnKaydet_Click" Text="Güncelle" />
